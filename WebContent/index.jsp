            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/carousel-1.png" alt="Carousel Image">
                        <div class="carousel-caption">
                            <p class="animated fadeInRight">We Are Professional</p>
                            <h1 class="animated fadeInLeft">We Help you build Your Career in Data Analyst</h1>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    ...
                                    <h3>A Career Change</h3>

                                    <p>Your current career does not excite you enough. You are looking to upskill and shift into a new-age career with great growth potential. </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12">
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    <h3>Career Growth</h3>
                                    <p>You are in your chosen space but would like to accelerate your career. Acquiring new skills and certification helps you take on many more opportunities.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="section-header text-left">
                                ...
                                <h2>welcome to learners website </h2>
                            </div>
            ...
            <div id="cource">
                <div class="container">
                    <div class="section-header text-center">
                        ...
                        <h2>All About Our Courses</h2>
                    </div>
                    <div class="row">
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="team-item">
                                <div class="team-img">
                                    <img src="img/DA2.jpg" alt="Team Image">
                                </div>
                                <div class="team-text">
                                    <h2>Data Analyst</h2>
                                    <p>Duration :6month</p>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="footer-contact">
                                ...
                                <p><i class="fa fa-phone-alt"></i>+9187767866</p>
                                <p><i class="fa fa-envelope"></i>carreer12@gmail.com</p>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="newsletter">
                                <h2>For this Course Apply </h2>
                             
                               
                               <a href="">who have completed 12th with the 60% grade</a><br>
                              <a href="">Only Those Student can be Apply</a>
                               <div class="form">
